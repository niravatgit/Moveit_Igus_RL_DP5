...
def all_close(goal, actual, tolerance):
    ...
    if type(goal) is list:
        ...
        return d <= tolerance and cos_phi_half >= cos(tolerance / 3.0)
...
class MoveGroupPythonInterfaceTutorial(object):
    ...
    def plan_cartesian_path(self, scale=1):
        ...
        wpose.position.x += scale * 0.67  # Second move forward/backwards in (x)
        waypoints.append(copy.deepcopy(wpose))

        wpose.position.y -= scale * -0.19  # Third move sideways (y)
        waypoints.append(copy.deepcopy(wpose))
        ...
        (plan, fraction) = move_group.compute_cartesian_path(
            waypoints, 0.1, 0.12  # waypoints to follow  # eef_step
        )  # jump_threshold
    ...
    def wait_for_state_update(
        self, box_is_known=False, box_is_attached=False, timeout=10
    ):
        # Copy class variables to local variables to make the web tutorials more clear.
        # In practice, you should use the class variables directly unless you have a good
        # reason not to.
    ...
    def attach_box(self, timeout=10):
        # Copy class variables to local variables to make the web tutorials more clear.
        # In practice, you should use the class variables directly unless you have a good
        # reason not to.
        box_name = self.box_name
    ...
    def detach_box(self, timeout=10):
        # Copy class variables to local variables to make the web tutorials more clear.
        # In practice, you should use the class variables directly unless you have a good
        # reason not to.
        box_name = self.box_name
    ...
    def remove_box(self, timeout=10):
        # Copy class variables to local variables to make the web tutorials more clear.
        # In practice, you should use the class variables directly unless you have a good
        # reason not to.
        box_name = self.box_name
