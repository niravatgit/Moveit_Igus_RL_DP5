...
class D1:
    ...
    def profile_pos_mode(self,position,velo,acc):
        ...
        print( 'Positon = ', position, ' position_value = ', self.position_value, ' *self.SI_unit_fact = ', self.SI_unit_fact)
...
class ClickAndHoldApp:
    ...
    def jog(self, event, axis, direction):
        self.axis_controller.axes[axis].profile_pos_mode(direction*1, 5,50)
