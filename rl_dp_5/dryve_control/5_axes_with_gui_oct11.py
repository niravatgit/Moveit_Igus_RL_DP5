...
class D1:
    ...
    def homing(self):
        ...
        self.sendCommand(enableOperationArray)
# Aaxis=D1("169.254.0.3", 502, 'Linear A-Axis') 
# Baxis=D1("169.254.0.4", 502, 'Linear X-Axis') 
# Caxis=D1("169.254.0.5", 502, 'Linear A-Axis') 

# Aaxis.startProcedure()
# Baxis.startProcedure()
# Caxis.startProcedure()
# # print(Aaxis.getPosition())
# print(Caxis.getPosition())
# Baxis.targetVelocity(500)
...
# dryveInit()
# Baxis.targetPosition(50)
# Caxis.targetPosition(50)
# print(Caxis.getPosition())
...
heading_label = tk.Label(frame, text="IGUS RLDP5 Robotic Arm Control Panel", font=("Helvetica", 16))
heading_label.grid(row=0, column=0, columnspan=4, pady=(0, 20))
...
for axis in range(5):
    ...
    position_label.grid(row=axis + 1, column=0, columnspan=2)
...
class ClickAndHoldApp:
    def __init__(self, root, axis_controller, position_labels):
        ...
        for axis in range(5):
            ...
            anticlockwise_button.grid(row=axis + 1, column=2, padx=10, pady=5)
            ...
            clockwise_button.grid(row=axis + 1, column=3, padx=10, pady=5)
        ...
        homing_button = tk.Button(frame, text="Homing", command=self.start_homing)
        homing_button.grid(row=6, column=0, columnspan=4, pady=20)
